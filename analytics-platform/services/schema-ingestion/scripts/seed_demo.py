...
def seed():
    ...
    with session_scope() as db:
        ...
        col_rev = ColumnMeta(table_id=table.id, column_name="revenue", data_type="numeric", description="Total revenue", updated_by=admin_user.email)
        col_reg = ColumnMeta(table_id=table.id, column_name="region", data_type="varchar", description="Sales region", updated_by=admin_user.email)
        col_date = ColumnMeta(table_id=table.id, column_name="sale_date", data_type="timestamp", description="Date of sale", updated_by=admin_user.email)
